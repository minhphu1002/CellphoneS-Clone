// Location
var header__location__wrapper = document.querySelector(
  ".header__location__wrapper"
);
var header__location__submenu = document.querySelector(
  ".header__location__submenu"
);
var header__location__submenu__modal = document.querySelector(
...
function DotHandler(index) {
  document
    .querySelector(".slider__bottom__item__underline.dot--active")
    .classList.remove("dot--active");
  DotBtns[index].classList.add("dot--active");
  document
    .querySelector(".slider__bottom__item.item--active")
...
// Chat with Supporter
var talk__with__supporter__bar = document.querySelector(
  ".talk__with__supporter__bar"
);
var talk__with__supporter__form = document.querySelector(
  ".talk__with__supporter__form"
);
var talk__with__supporter__form__header__close = document.querySelector(
  ".talk__with__supporter__form__header__close"
);
talk__with__supporter__bar.addEventListener("click", function () {
  talk__with__supporter__form.style = `display: block;`;
});
talk__with__supporter__form__header__close.addEventListener(
  "click",
  function () {
...
var $$$ = document.getElementsByClassName(
  "zalo__support__box__header__icon"
)[1];
var dropdown__zalo = document.querySelector(".dropdown__content");
var dropdown__zalo__btn = document.querySelector(
  ".zalo__support__box__header__icon"
);
...
Tab__dot__list.forEach(function (item, index) {
  item.onclick = function () {
    document
      .querySelector(".tablet__slider__dot__item.dot-list-style")
      .classList.remove("dot-list-style");
...
var smartphone__slider__wrapper = document.querySelector(
  ".smartphone__slider__wrapper"
);
var smartphone__dot__list = document.querySelectorAll(
  ".smartphone__slider__dot__item"
);
smartphone__dot__list.forEach(function (item, index) {
  item.onclick = function () {
    document
      .querySelector(".smartphone__slider__dot__item.dot-list-style")
      .classList.remove("dot-list-style");
    smartphone__slider__wrapper.style = `transform: translateX(${
      -345 * index
    }px);`;
    this.classList.add("dot-list-style");
  };
...
// Smartphone
var smartphone__header__search__input = document.querySelector(
  ".smartphone__header__search input"
);
var smartphone__modal = document.querySelector(".smartphone__modal");
var smartphone__header__location = document.querySelector(
  ".smartphone__header__location"
);
...
// Scroll Handle
var header__background__behavior = document.querySelector(
  ".tablet__header__background"
);
...
function HeaderScrollHandle(number) {
  if (number > 50) {
    this.document.querySelector(
      ".tablet__header__logo"
    ).style = `display : none`;
    this.document.querySelector(
      ".tablet__header__bottom"
    ).style = `display : none`;
    this.document.querySelector(
      ".tablet__header__logo__scroll"
    ).style = `display : block`;
    this.document.querySelector(
      ".tablet__header__bottom__scroll"
    ).style = `display : block`;
...
var search__bottom__sroll__input = document.querySelector(
  ".tablet__header__bottom__scroll input"
);
var tablet__header__location = document.querySelector(
  ".tablet__header__location"
);
...
var TabLocationDropdown = document.querySelector(
  ".tablet__header__location__menu__list"
);
TabLocationBtn = document.querySelector(".tablet__header__location");
TabLocationModal = document.querySelector(
  ".tablet__header__location__menu__list__modal"
);
